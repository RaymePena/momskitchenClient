            ...
            <v-container>
              <v-row>
                ...
                <v-col cols="12" sm="4">
                  ...
                  <v-text-field label="Prep Time" v-model="recipe.prepTime">
                  </v-text-field>
                  <v-text-field label="Cook Time" v-model="recipe.cookTime">
                  </v-text-field>
                  <v-text-field label="Servings" v-model="recipe.servings">
                  </v-text-field>
                  <v-radio-group v-model="recipe.share">
                    <v-radio
                      label="Public Recipe"
                      color="secondary"
                      :value="true"
  ...
  methods: {
    ...
    deleteInstructionField(index){
     ...
     gatherData() {
      ...
      formData.append("share", this.recipe.share);
